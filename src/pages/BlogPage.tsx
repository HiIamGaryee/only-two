        ...
        <Grid container spacing={4}>
          <Grid item xs={12} md={8}>
            <Card
              sx={{
                backgroundImage:
                  'url("http://img.zcool.cn/community/01a349556527710000008ec95520c7.jpg@2o.jpg")',
          ...
          <Grid item xs={12} md={4}>
            <Card
              sx={{
                backgroundImage:
                  'url("https://t4.ftcdn.net/jpg/06/04/25/67/360_F_604256779_amJh8y1RKHPwtHGNN5NCQJDiTrrUWGgS.jpg")',
                backgroundSize: "cover",
                backgroundPosition: "center",
                minHeight: "200px",
                position: "relative",
          ...
          <Grid item xs={12} md={4}>
            <Card
              sx={{
                backgroundImage:
                  'url("https://tse2.mm.bing.net/th?id=OIP.zBWANUITH4fqA19m1TeuQAHaE7&pid=Api&P=0&h=180")',
                backgroundPosition: "center",
                minHeight: "200px",
                position: "relative",
                color: "#ffffff",
          ...
          <Grid item xs={12} md={4}>
            <Card
              sx={{
                backgroundImage:
                  'url("https://i.ytimg.com/vi/UUJiDUDOtL8/hqdefault.jpg")',
                backgroundSize: "cover",
                backgroundPosition: "center",
                minHeight: "200px",
                position: "relative",
          ...
          <Grid item xs={12} md={4}>
            <Card
              sx={{
                backgroundImage:
                  'url("https://images.unsplash.com/photo-1601568873917-1d9f126f645f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60")',
                backgroundSize: "cover",
                backgroundPosition: "center",
                minHeight: "200px",
                position: "relative",
